...
public class AllTypeTableColumn {
  ...
  static {
    ...
    // 日期时间类型
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("DATE").value("date '10-10-2010'").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("TIME").value("'21:21:21'").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("TIMETZ").value("'21:21:21 pst'").build());
    ALL_COLUMN_TYPE.add(
    ...
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("TIMESTAMPTZ")
            .value("'2013-12-11 pst'")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("SMALLDATETIME")
            .value("'2003-04-12 04:05:06'")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
    ...
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("INTERVAL YEAR")
            .value("interval '2' year")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("reltime").value("'90'").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("abstime")
            .value("'1901-12-13 20:45:53 GMT'")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("oradate")
            .value("date '10-10-2010'")
            .build());
    ...
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            ...
            .notSupportedTypes(
                Arrays.asList(
                    NotSupportedType.ORACLE,
                    NotSupportedType.MYSQL,
                    NotSupportedType.TERADATA,
                    NotSupportedType.PG))
            .build());
    ALL_COLUMN_TYPE.add(
    ...
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("DEC(10,3)").value("").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("INTEGER(10,3)").value("").build());

    // 货币类型
    ALL_COLUMN_TYPE.add(AllTypeTableColumn.builder().name("col").type("money").value("").build());
    // 布尔类型
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("BOOLEAN").value("true").build());
    // 字符类型
    ALL_COLUMN_TYPE.add(
    ...
    // 几何类型
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("point").value("point '(2.0,0)'").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("line")
    ...
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("lseg")
            .value("lseg(point '(-1,0)', point '(1,0)')")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("box")
            .value("box(circle '((0,0),2.0)')")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("path")
            .value("path(polygon '((0,0),(1,1),(2,0))')")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("polygon")
            .value("polygon(box '((0,0),(1,1))')")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("circle")
            .value("circle(box '((0,0),(1,1))')")
            .build());
    // 网络地址类型
    ALL_COLUMN_TYPE.add(AllTypeTableColumn.builder().name("col").type("cidr").value("").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("inet").value("inet '192.168.1.5'").build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("macaddr")
            .value("macaddr '12:34:56:78:90:ab'")
            .build());
    // 位串类型
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("bit(3)").value("B'101'").build());
    ALL_COLUMN_TYPE.add(
    ...
    // HLL数据类型
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder().name("col").type("hll").value("hll_empty()").build());
    // 范围类型
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("int4range")
            .value("int4range(15, 25)")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("int8range")
            .value("int8range(15, 25)")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("numrange")
            .value("numrange(20.0, 30.0)")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("tsrange")
            .value("'[2010-01-01 14:30, 2010-01-01 15:30)'")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("tstzrange")
            .value("'[2010-01-01 14:30 +08:00, 2010-01-01 15:30 +08:00)'")
            .build());
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
    ...
    ALL_COLUMN_TYPE.add(
        AllTypeTableColumn.builder()
            .name("col")
            .type("hash32")
            .value("'685847ed1fe38e18f6b0e2b18c00edee'")
            .build());
