...
public class Sorted_Select extends Sorted {
    public Sorted_Select(int testTimes, int maxSize, int maxValue) {
    ...
    public static void main(String[] args) {
        ...
        int maxSize = 1000;
        int maxValue = 1000;
        Sorted sorted = new Sorted_Select(testTimes, maxSize, maxValue);
        sorted.template();
    }
