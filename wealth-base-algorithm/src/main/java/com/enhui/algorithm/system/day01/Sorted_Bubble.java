...
public class Sorted_Bubble extends Sorted {

    public Sorted_Bubble(int testTimes, int maxSize, int maxValue) {
    ...
    public static void main(String[] args) {
        ...
        int maxSize = 1000;
        int maxValue = 1000;
        Sorted sorted = new Sorted_Bubble(testTimes, maxSize, maxValue);
        sorted.template();
    }
