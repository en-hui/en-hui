...
public class Sorted_Merge extends Sorted {
    public Sorted_Merge(int testTimes, int maxSize, int maxValue) {
    ...
    public static void main(String[] args) {
        ...
        int maxSize = 100;
        int maxValue = 1000;
        Sorted sorted = new Sorted_Merge(testTimes, maxSize, maxValue);
        sorted.template();
    }
