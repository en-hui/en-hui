...
- Idea中，调整参数的方式见下图
![Alt](../简介img/Idea修改参数.png)
- 参数修改后重新查看，可在下图验证堆内存结构
![Alt](../简介img/修改后的参数.png)
- 内存溢出的过程
![Alt](../简介img/内存溢出的过程.png)
